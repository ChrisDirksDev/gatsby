...
export const SummaryPanel = ({ className }) => {
  ...
  const desc =
    "I love turning whats old and busted into something that is shiney and new, or chruning out an exact responsive replica of a mockup ive been given. I also enjoy being given a blank slate and allowing styles and design to spring forth naturally from a few key requirements. Most of all, however, I enjoy making experiances that are fun and easy to use."
  const description = (
    <PanelDescription
